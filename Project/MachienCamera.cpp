...
namespace machien
{
	void MachienCamera::SetOrtoGraphProjection(float left, float right, float top, float bottom, float near, float far)
	{
		m_ProjectionMatrix = glm::ortho(left, right, bottom, top, near, far);
	}

	void MachienCamera::SetPerspectiveProjection(float fov, float aspect, float near, float far)
	{
	...
	void MachienCamera::SetViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up)
	{
	...
	void MachienCamera::SetViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up)
	{
		SetViewDirection(position, target - position, up);
	}

	void MachienCamera::SetViewYXZ(glm::vec3 position, glm::vec3 rotation)
	{
